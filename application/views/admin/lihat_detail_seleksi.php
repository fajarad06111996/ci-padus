            ...
            <div class="row clearfix">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
						<form action="<?php echo base_url("admin/tambah_penempatan_mahasiswa/$id_register"); ?>" method="post">
                            <div class="row clearfix"><center>
							<?php if($cek_penempatan_mahasiswa == 1) { ?>
