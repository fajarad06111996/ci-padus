                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
								...
								<?php foreach($tampil_soal as $v) { ?>
                                     <tr>
                                        ...
                                        <td>
										<a href="<?php echo base_url("admin/buka_soal/$v->kode"); ?>" class="btn btn-info waves-effect">Lihat</a>
										<a href="<?php echo base_url("admin/hapus_soal/$v->kode"); ?>" class="btn btn-danger waves-effect">Hapus</a>
										<a href="<?php echo base_url("admin/edit_waktu_soal/$v->kode"); ?>" class="btn btn-primary waves-effect">Ubah Waktu</a>
										</td>
                                    </tr>
								<?php } ?>
                                </tbody>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <!-- modal header -->
								...
								<div class="form-group">
                                        <div class="form-line date" id='datetimepicker1'>
                                            <input type="text" name="waktu_mulai" class="form-control" value="<?php echo date('Y-m-d H:i:s'); ?>" required>
                                        </div>
                                    </div>
								 <label>Waktu Kahir</label>  
								<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="waktu_akhir" class="form-control" value="<?php echo date('Y-m-d H:i:s'); ?>" required>
                                        </div>
                                    </div>
