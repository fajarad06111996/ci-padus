                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
								...
								<?php foreach($tampil_jurusan as $v) { ?>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo base_url("admin/edit_jurusan/$v->id_jurusan"); ?>" class=" waves-effect waves-block">Edit</a></li>
                                        <li><a href="<?php echo base_url("admin/hapus_jurusan/$v->id_jurusan"); ?>" onclick="return confirm('Yakin Untuk Menghapus')" class=" waves-effect waves-block">Hapus</a></li>
                                    </ul>
                                </div>
										</td>
                                    </tr>
