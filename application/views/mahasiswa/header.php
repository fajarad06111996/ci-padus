        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><b>MAHASISWA</b></div>
                    <div class="email"><?php echo $nama; ?></div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
                           <li><a href="<?php echo base_url("mahasiswa/akun_mahasiswa"); ?>"><i class="material-icons">person</i>Akun</a></li>
            ...
            <div class="menu">
                <ul class="list">
					...
					<li>
                        <a href="<?php echo base_url(); ?>mahasiswa/data_mahasiswa">
					...
					<!-- <li>
                        <a href="<?php echo base_url(); ?>mahasiswa/data_bagian">
                            <i class="material-icons">insert_drive_file</i>
                            <span>Data UKM</span>
                        </a>
                    </li> -->
					...
					<li>
                        <a href="<?php echo base_url(); ?>mahasiswa/data_soal">
                            <i class="material-icons">insert_drive_file</i>
                            <span>Data Soal</span>
                        </a>
                    </li>
					...
					<li>
                        <a href="<?php echo base_url(); ?>mahasiswa/hasil">
                            <i class="material-icons">insert_drive_file</i>
                            <span>Hasil</span>
                        </a>
                    </li>
					<li>
                        <a href="<?php echo base_url(); ?>mahasiswa/pengumumman">
                            <i class="material-icons">insert_drive_file</i>
