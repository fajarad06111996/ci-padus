...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" action="<?php echo base_url('app/loginadmin'); ?>" method="POST">
                    <div class="msg">Masukan NIK Dan Password</div>
                    ...
                    <div class="row m-t-15 m-b--20">
                        <div class="col-xs-6">
                            <a href="<?php echo base_url("app/index"); ?>">Register Mahasiswa!</a> || <a href="<?php echo base_url("app/login"); ?>">Login Mahasiswa!</a>
                        </div>
